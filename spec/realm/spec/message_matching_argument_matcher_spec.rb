  ...
  module Spec
    describe MessageMatchingArgumentMatcher do
      ...
      it "matches when it matches" do
        expect(message_matching(message_type: :test_message_type, uuid: :test_uuid, foo: "bar")).to be == message
      end

      it "doesn't match when it doesn't match" do
        expect(message_matching(message_type: :test_message_type, uuid: :test_uuid, foo: "baz")).to_not be == message
      end
